...
func (h *Handler) GetApiV1BlacklistRegex(c *gin.Context) {
	filters, err := h.Service.GetRegexFilters(types.Blacklist, c)
	if err != nil {
...
func (h *Handler) PostApiV1BlacklistRegex(c *gin.Context) {
	var req oapi.PostApiV1BlacklistRegexJSONRequestBody
	...
	filter, err := h.Service.CreateRegex(req.Pattern, types.Blacklist, c)
	if err != nil {
...
func (h *Handler) PutApiV1BlacklistRegexId(c *gin.Context, id int) {
	var req oapi.PutApiV1BlacklistRegexIdJSONRequestBody
	if err := c.ShouldBindJSON(&req); err != nil {
...
func (h *Handler) DeleteApiV1BlacklistRegexId(c *gin.Context, id int) {
